...
export function GoogleLeadBanner() {
  ...
  return (
    <div className="fixed bottom-6 ltr:left-6 rtl:right-6 z-50 w-[calc(100%-3rem)] max-w-sm px-4 py-4 bg-[#0d1117] border border-blue-500/30 rounded-sm shadow-2xl shadow-black/50 backdrop-blur-md">
      <button
        onClick={dismiss}
      ...
      <div className="flex items-start gap-3">
        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center flex-shrink-0 border border-blue-500/20 shadow-md shadow-blue-500/10">
