  ...
  en: {
    ...
    twoPaths: {
      ...
      offer2: {
        ...
        btn: "Start Coaching — 1,399 LE / 79 €",
        renewal: "Renewal: 999 LE / 69 € / 3 months",
      },
    },
    trainingDetail: {
      badge: "Offer 01 · 399 LE / 19 €",
    ...
    coachingDetail: {
      badge: "Offer 02 · 1,399 LE / 79 € · 3 Months",
      ...
      feature3: "Renewal available after 3 months — 999 LE / 69 €",
      btn: "START COACHING — 1,399 LE / 79 €",
    },
    howItWorks: {
      badge: "Process",
      ...
      planTrack: "Training Plan · 399 LE / 19 €",
      coachingTrack: "Personal Coaching · 1,399 LE / 79 €",
      planSteps: [
      ...
      coachingSteps: [
        ...
        { step: "06", title: "Renew", desc: "Continue your transformation — 999 LE / 69 € / 3 months" },
      ],
    },
    coach: {
    ...
    finalCta: {
      ...
      planBtn: "Start Your Plan — 399 LE / 19 €",
      coachingBtn: "Work With Me — 1,399 LE / 79 €",
    ...
    footer: {
      ...
      navigate: "Navigate",
      offers: "Offers",
      planOffer: "Training Plan — 399 LE / 19 €",
      coachingOffer: "Personal Coaching — 1,399 LE / 79 €",
  ...
  ar: {
    ...
    twoPaths: {
      ...
      offer2: {
        ...
        btn: "ابدأ التدريب الآن — ١,٣٩٩ ج.م / 79 €",
        renewal: "التجديد بعد ٣ شهور: ٩٩٩ ج.م / 69 € فقط",
      },
    },
    trainingDetail: {
      badge: "العرض الأول · ٣٩٩ ج.م / 19 €",
    ...
    coachingDetail: {
      badge: "العرض الثاني · ١,٣٩٩ ج.م / 79 € · ٣ شهور",
      ...
      feature3: "إمكانية التجديد بعد ٣ شهور بسعر ٩٩٩ ج.م / 69 € فقط",
      btn: "ابدأ التدريب الشخصي — ١,٣٩٩ ج.م / 79 €",
    },
    howItWorks: {
      badge: "خطوات العمل",
      title: "كيف يعمل النظام؟",
      subtitle: "بسيط، واضح، ومؤتمت بالكامل. من لحظة الدفع وحتى استلام خطتك وبدء التمرين بدون أي تأخير.",
      planTrack: "خطة التدريب · ٣٩٩ ج.م / 19 €",
      coachingTrack: "التدريب والمتابعة الشخصية · ١,٣٩٩ ج.م / 79 €",
      planSteps: [
      ...
      coachingSteps: [
        ...
        { step: "06", title: "تجديد الاشتراك", desc: "إمكانية مواصلة التحول بخصم حصري ٩٩٩ ج.م / 69 € / ٣ شهور" },
      ],
    },
    coach: {
      badge: "مدربك الشخصي",
      ...
      items: [
        {
          ...
          a: "خطة التدريب (٣٩٩ ج.م / 19 €) هي نظام تدريبي علمي ومنظم تم بناؤه بأفضل المنهجيات المجربة، ولكنها غير مخصصة لقياساتك الفردية اليومية. إذا كنت تبحث عن خطة مخصصة 100% لجسمك مع دايت ومتابعة أسبوعية، فإن باقة التدريب الشخصي (١,٣٩٩ ج.م / 79 €) هي الخيار المثالي.",
        },
        {
        ...
        },
        {
          ...
          a: "عند اقتراب انتهاء المدة، يظهر لك خيار التجديد داخل لوحة التحكم بسعر مخفض ٩٩٩ ج.م / 69 € لـ ٣ شهور إضافية للاستمرار في تحقيق أهدافك بدون انقطاع.",
        },
        {
          q: "هل يمكنني تجديد المتابعة لاحقاً؟",
          a: "نعم، التجديد متاح لجميع المشتركين بسعر ٩٩٩ ج.م / 69 € فقط لكل ٣ شهور إضافية مع الاحتفاظ بكافة بياناتك وسجلات تقدمك السابقة.",
        },
        {
    ...
    finalCta: {
      ...
      planBtn: "احصل على خطة التدريب — ٣٩٩ ج.م / 19 €",
      coachingBtn: "اشترك في المتابعة الشخصية — ١,٣٩٩ ج.م / 79 €",
    ...
    footer: {
      ...
      planOffer: "خطة التدريب — ٣٩٩ ج.م / 19 €",
      coachingOffer: "التدريب والمتابعة الشخصية — ١,٣٩٩ ج.م / 79 €",
