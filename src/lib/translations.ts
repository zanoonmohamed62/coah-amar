  ...
  en: {
    ...
    twoPaths: {
      ...
      offer1: {
        ...
        btn: "Get The Split — 299 EGP / 11 €",
        delivery: "Instant access to dashboard after payment",
      },
      offer2: {
        ...
        btn: "Start Coaching — 1,499 EGP / 71 €",
        renewal: "Renewal after 3 months: 1,999 EGP / 99 € only",
      },
    },
    trainingDetail: {
      badge: "Offer 01 · 299 LE / 11 € (Was 499 LE)",
      titleLine1: "THE AMAR",
      titleLine2: "X SPLIT",
    ...
    coachingDetail: {
      badge: "Offer 02 · 1,499 LE / 71 € · 3 Months",
      ...
      btn: "START COACHING — 1,499 LE / 71 €",
    },
    howItWorks: {
      badge: "Process",
      title: "How It Works",
      subtitle: "Simple, transparent, fully automated. From payment to plan — no waiting, no confusion.",
      planTrack: "Training Plan · 299 LE / 11 €",
      coachingTrack: "Personal Coaching · 1,499 LE / 71 €",
      planSteps: [
      ...
      items: [
        {
          ...
          a: "The Training Plan (299 LE / 11 € - regular 499 LE) is a structured, science-based system built using proven methodology. It is not customized to your individual measurements. For fully personalized programming, Personal Coaching (1,499 LE / 71 € - regular 2,499 LE) is the right choice.",
        },
        {
    ...
    finalCta: {
      ...
      planBtn: "Get The Split — 299 LE / 11 €",
      coachingBtn: "Work With Me — 1,499 LE / 71 €",
    ...
    footer: {
      ...
      navigate: "Navigate",
      offers: "Offers",
      planOffer: "Training Plan — 299 LE / 11 €",
      coachingOffer: "Personal Coaching — 1,499 LE / 71 €",
  ...
  ar: {
    ...
    twoPaths: {
      ...
      offer1: {
        ...
        btn: "احصل على السبليت — ٢٩٩ ج.م / 11 €",
      ...
      offer2: {
        ...
        btn: "ابدأ التدريب الآن — ١,٤٩٩ ج.م / 71 €",
        renewal: "التجديد بعد ٣ شهور: 1,999 ج.م / 99 € فقط",
      },
    },
    trainingDetail: {
      badge: "العرض الأول · ٢٩٩ ج.م / 11 €",
      titleLine1: "عمار",
      titleLine2: "X سبليت",
    ...
    coachingDetail: {
      badge: "العرض الثاني · ١,٤٩٩ ج.م / 71 € · ٣ شهور",
      ...
      btn: "ابدأ التدريب الشخصي — ١,٤٩٩ ج.م / 71 €",
    },
    howItWorks: {
      badge: "خطوات العمل",
      title: "كيف يعمل النظام؟",
      subtitle: "بسيط، واضح، ومؤتمت بالكامل. من لحظة الدفع وحتى استلام خطتك وبدء التمرين بدون أي تأخير.",
      planTrack: "خطة التدريب · ٢٩٩ ج.م / 11 €",
      coachingTrack: "التدريب والمتابعة الشخصية · ١,٤٩٩ ج.م / 71 €",
      planSteps: [
    ...
    faq: {
      ...
      items: [
        {
          q: "هل خطة التدريب (٢٩٩ ج.م / 11 €) مخصصة لجسمي فقط؟",
          a: "خطة التدريب (عمار X سبليت بسعر ٢٩٩ ج.م / 11 € بدلاً من ٤٩٩ ج.م) هي نظام تدريبي علمي ومنظم تم بناؤه بأفضل المنهجيات المجربة، ولكنها غير مخصصة لقياساتك الفردية اليومية. إذا كنت تبحث عن خطة مخصصة 100% لجسمك مع دايت ومتابعة أسبوعية، فإن باقة التدريب الشخصي (١,٤٩٩ ج.م / 71 € بدلاً من ٢,٤٩٩ ج.م) هي الخيار المثالي.",
        },
        {
    ...
    finalCta: {
      ...
      planBtn: "احصل على السبليت — ٢٩٩ ج.م / 11 €",
      coachingBtn: "اشترك في المتابعة الشخصية — ١,٤٩٩ ج.م / 71 €",
    ...
    footer: {
      ...
      planOffer: "خطة التدريب — ٢٩٩ ج.م / 11 €",
      coachingOffer: "التدريب والمتابعة الشخصية — ١,٤٩٩ ج.م / 71 €",
