  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] max-w-2xl mx-auto text-center space-y-10">
      <div className="space-y-4">
        ...
        <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-[var(--radius-pill)] bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-bold uppercase tracking-wider mb-2 shadow-[0_0_15px_rgba(59,130,246,0.2)]">
      ...
      <div className="w-full flex flex-col gap-4 mt-6">
        ...
        <Link
          href="/app/my-split"
          className="group relative w-full py-6 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-black text-lg rounded-[var(--radius-lg)] transition-all duration-300 flex flex-col items-center justify-center gap-3 shadow-[0_8px_30px_rgb(59,130,246,0.3)] hover:shadow-[0_8px_40px_rgb(59,130,246,0.5)] border border-blue-400/20 overflow-hidden"
        >
          ...
          <FileText size={20} className="drop-shadow-lg group-hover:scale-110 transition-transform duration-300" />
        ...
        <a
          ...
          className="group w-full py-4 bg-[#0d121c] border border-blue-500/20 hover:border-blue-500/50 hover:bg-blue-500/5 text-[var(--text-primary)] font-bold text-sm rounded-[var(--radius-lg)] transition-all duration-300 flex items-center justify-center gap-2.5 shadow-[var(--shadow-button)]"
        >
          <div className="p-1.5 rounded-[var(--radius-pill)] bg-blue-500/10 group-hover:bg-blue-500/20 transition-colors">
            <MessageCircle size={16} className="text-blue-400 drop-shadow-md" />
          </div>
